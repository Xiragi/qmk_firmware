...
*/
    [WIN_BASE] = LAYOUT_tkl_iso(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,                                      KC_APP,   KC_RGUI, MO(WIN_FN),KC_RCTL,    KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [WIN_FN] =  LAYOUT_tkl_iso(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______,      _______, _______, RGB_SPI,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______,               _______, _______, RGB_SPD,
